class RailwayStation < ApplicationRecord
  ...
  scope :order_stations, -> { select('railway_stations.*, railway_stations_routes.station_number').joins(:railway_stations_routes).order("railway_stations_routes.station_number").uniq }
